    ...
    <div class="footer">
       <div class="footer_box">
            ...
            <div class="notice_area">
                <p>구해줘패션(주)는 통신판매 중개자로서 통신판매의 당사자가 아닙니다. 본 상품은 개별판매자가 등록한 상품으로 상품, 상품정보, 거래에 관한 의무와 책임은 각 판매자에게 있습니다. 단, 이용약관 및 정책, 기타 거래 체결 과정에서 고지하는 내용 등에 따라 검수하고 보증하는 내용에 대한 책임은 구해줘패션(주)에 있습니다.</p>
            </div>
       </div> 
    </div>
